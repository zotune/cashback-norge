...
async function main(): Promise<void> {
  ...
  const fullDomainLookup = buildDomainLookup([
    ...
    ...usblOffers, ...bateOffers, ...nafOffers, ...studentkortetOffers, ...nettbonusOffers,
