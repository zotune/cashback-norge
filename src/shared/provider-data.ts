...
export const SUPPORT_LINKS = [
  ...
  { text: "Horde: 500p bonus + oversikt →", emoji: "📊", url: "https://app.horde.no/66CS/verve?code=kloube" },
  { text: "Kjøp en kaffe til utvikler →", emoji: "☕", url: "https://buymeacoffee.com/adore" },
  { text: "Opptil 2 500 kr med Revolut →", emoji: "💳", url: "https://revolut.com/referrals?r=FELPJK" },
];
