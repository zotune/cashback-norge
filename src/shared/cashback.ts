...
export type CashbackProvider = "trumf" | "klarna" | "remember" | "sas" | "tfbank" | "dnb" | "curve" | "rabattkode" | "norskfamilie" | "obos" | "bob" | "usbl" | "bate" | "logbuy" | "naf" | "tekna" | "nito" | "sparebank1" | "studentkortet" | "nettbonus" | "spenn" | "spareborsen" | "rabble" | "dreams" | "utdanningibergen" | "unidays" | "cbn" | "studenttorget" | "unio";
...
export function isCashbackProvider(value: unknown): value is CashbackProvider {
  return value === "trumf" || value === "klarna" || value === "remember" || value === "sas" || value === "tfbank" || value === "dnb" || value === "curve" || value === "rabattkode" || value === "norskfamilie" || value === "obos" || value === "bob" || value === "usbl" || value === "bate" || value === "logbuy" || value === "naf" || value === "tekna" || value === "nito" || value === "sparebank1" || value === "studentkortet" || value === "nettbonus" || value === "spenn" || value === "spareborsen" || value === "rabble" || value === "dreams" || value === "utdanningibergen" || value === "unidays" || value === "cbn" || value === "studenttorget" || value === "unio";
}
